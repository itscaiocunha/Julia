...
const integrations = [
  { img: "/images/logo/Trinks-Logo.png", name: "Trinks", url: "https://www.trinks.com.br/" },
  ...
  { img: "/images/logo/Mailchimp-Logo.png", name: "Mailchimp", url: "https://Mailchimp.com/" },
          ...
          <form onSubmit={handleQuestionSubmit} className="space-y-6">
            <div>
              <label className="block text-xl font-medium mb-4">
                Qual é o maior desafio no atendimento do seu salão de estética?
              </label>
              <textarea
                required
                rows={4}
      ...
      case 2:
        return (
          <form onSubmit={handleQuestionSubmit} className="space-y-6">
            <div>
              <label className="block text-xl font-medium mb-4">
                Quantos agendamentos seu salão recebe por mês?
              </label>
              <textarea
                required
                rows={4}
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-b from-[#ED4694] to-white text-transparent bg-clip-text w-full md:w-[90%] lg:w-[100%]">
              Sua marca de cosméticos em primeiro lugar!
            </h1>
          ...
          <div className="relative flex justify-center">
            ...
            <img className="w-full max-w-[800px]" src="/images/Salão.png" alt="Conversa de atendimento virtual para salão" />
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Respostas rápidas para clientes",
                description: "Tire dúvidas sobre serviços, preços e horários de forma instantânea, garantindo um atendimento ágil e eficiente."
              },
              {
                icon: <Star className="w-8 h-8 text-yellow-400" />,
                title: "Fidelização de clientes",
                description: "Mantenha contato com seus clientes, envie lembretes e promoções para fortalecer a relação e aumentar a retenção."
              }
            ].map((feature, index) => (
      ...
      <section id="cadastro" className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          ...
          <button
            ...
            onClick={() => window.open('https://share.hsforms.com/12cCwv02kSUOEBPaYfJRYYAblq37', '_blank')}
          >
