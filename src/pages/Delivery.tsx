...
import { ShieldCheck, MessageCircle, Clock, Calendar, ArrowRight } from 'lucide-react';
...
const integrations = [
  ...
  { img: "/images/logo/Salesforce-Logo.png", name: "Salesforce", url: "https://Salesforce.com/" },
  ...
  { img: "/images/logo/UberEats-Logo.png", name: "Uber Eats", url: "https://UberEats.com/" },
  { img: "/images/logo/Cielo-Logo.png", name: "Cielo", url: "https://www.Cielo.com.br/" },
  { img: "/images/logo/PagSeguro-Logo.png", name: "PagSeguro", url: "https://pagseguro.uol.com.br/" },
  { img: "/images/logo/Rappi-Logo.png", name: "Rappi", url: "https://www.rappi.com.br/" },
  { img: "/images/logo/PayPal-Logo.png", name: "PayPal", url: "https://www.paypal.com/br/home" },
  { img: "/images/logo/Onfleet-Logo.png", name: "Onfleet", url: "https://Onfleet.com/" }
];
          ...
          <form onSubmit={handleQuestionSubmit} className="space-y-6">
            <div>
              <label className="block text-xl font-medium mb-4">
                Qual é o maior desafio no atendimento do seu restaurante?
              </label>
              <textarea
                required
                rows={4}
                ...
                placeholder="Descreva seu desafio no atendimento"
              />
            </div>
            <button
              type="submit"
      ...
      case 2:
        return (
          <form onSubmit={handleQuestionSubmit} className="space-y-6">
            <div>
              <label className="block text-xl font-medium mb-4">
                Quantos pedidos seu restaurante recebe por mês?
              </label>
              <textarea
                required
                rows={4}
                ...
                placeholder="Informe a quantidade de pedidos mensais"
              />
            </div>
            <button
              type="submit"
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-4xl mx-auto aspect-video rounded-2xl overflow-hidden bg-gray-800">
            <iframe
              ...
              src="https://w7startup.com.br/video/Restaurantes.mp4"
              title="Julia Demo"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
            Como a Julia transforma o atendimento no seu restaurante
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: <Clock className="w-8 h-8 text-blue-400" />,
                title: "Pedidos organizados e sem atrasos",
                description: "Evite confusões e atrasos nas entregas. A Julia gerencia seus pedidos e organiza os tempos de preparo automaticamente."
              },
              {
                icon: <MessageCircle className="w-8 h-8 text-teal-400" />,
                title: "Atendimento instantâneo",
                description: "Responda dúvidas dos clientes automaticamente e aumente suas vendas sem precisar estar sempre online."
              },
              {
                icon: <ShieldCheck className="w-8 h-8 text-green-400" />,
                title: "Segurança e eficiência",
                description: "A Julia protege os dados dos seus clientes e agiliza seu atendimento, garantindo uma experiência confiável e moderna."
              }
            ].map((feature, index) => (
