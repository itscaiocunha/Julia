          ...
          <form onSubmit={handleQuestionSubmit} className="space-y-6">
            <div>
              <label className="block text-xl font-medium mb-4">
                Qual é o maior desafio no atendimento ao cliente na sua operadora ou empresa de telecom?
              </label>
              <textarea
                required
                rows={4}
                ...
                placeholder="Descreva os desafios no suporte e atendimento"
              />
            </div>
            <button
              type="submit"
          ...
          <form onSubmit={handleQuestionSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Digite a média de atendimentos mensais"
              />
            </div>
            <button
              type="submit"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
            Como a Julia revoluciona o atendimento na sua operadora de telecom
          </h2>
      ...
      <section id="cadastro" className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          ...
          <button
            ...
            onClick={() => window.open('https://share.hsforms.com/1HM2aENF4RR-oRdswSfGAqwblq37', '_blank')}
          >
